...
type
  ...
  public
    ...
    function AddBreak(const AFuncName: String; AnEnabled: Boolean = True): TFpInternalBreakpoint; overload; // fred fix
...
function TDbgInstance.AddBreak(const AFileName: String; ALine: Cardinal;
  AnEnabled: Boolean): TFpInternalBreakpoint; // fred fix
var
  addr: TDBGPtrArray;
begin
  Result := nil;
