...
//            end;
      ...
      SIGFPE:
        begin
        ExceptionClass:='SIGFPE (Division by zero)';
        TDbgLinuxThread(AThread).FExceptionSignal:=SIGFPE;
        result := deException;
        end; 
      SIGALRM:
        begin
        TDbgLinuxThread(AThread).FExceptionSignal:=SIGALRM;
        result := deInternalContinue;
        end;    
      SIGPIPE:
        begin
        TDbgLinuxThread(AThread).FExceptionSignal:=SIGPIPE;
        result := deInternalContinue;
        end;
      SIGCHLD:
        begin
